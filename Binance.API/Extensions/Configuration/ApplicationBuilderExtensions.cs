...
public static class ApplicationBuilderExtensions
{
    ...
    public static void UseWatchdog(this IApplicationBuilder app, ConfigurationManager configurationManager)
    {
        var watchdogSettings = configurationManager.GetSection(nameof(WatchDogSettings)).Get<WatchDogSettings>();
